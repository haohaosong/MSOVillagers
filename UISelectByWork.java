...
* author:haohaosong
* date:2016/12/17
* note:The UISelectByWork interface when the admin wants to select the information
*/
...
public class UISelectByWork extends JFrame implements ActionListener  
{   
         //定义组件  
